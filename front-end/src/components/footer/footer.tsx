  ...
  return (
    <footer className='w-full pt-16 md:pt-32 lg:pt-56 pb-4 px-4 md:px-6 lg:px-10 flex flex-col'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16 w-full max-w-6xl mx-auto'>
        ...
        {/* Location Section */}
        <section id="FooterLocal" className="flex flex-col text-gray-600 text-center md:text-left">
          <h3 className="text-base font-semibold text-gray-800 mb-3 md:hidden">Location</h3>
        ...
        <section className="flex flex-col space-y-3 text-gray-600 text-center md:text-left">
          <h1 className="text-base font-bold text-gray-800 mb-1">Links</h1>
          <a href="#" className="text-sm hover:text-black transition-colors">Home</a>
          <a href="#" className="text-sm hover:text-black transition-colors">Shop</a>
          <a href="#" className="text-sm hover:text-black transition-colors">About</a>
          <a href="#" className="text-sm hover:text-black transition-colors">Contact</a>
        </section>
            
        {/* Help Section */}
        <section id="FooterHelp" className="flex flex-col space-y-3 text-gray-600 text-center md:text-left">
          <h1 className="text-base font-bold text-gray-800 mb-1">Help</h1>
          <a href="#" className="text-sm hover:text-black transition-colors">Payment Options</a>
          <a href="#" className="text-sm hover:text-black transition-colors">Returns</a>
          <a href="#" className="text-sm hover:text-black transition-colors">Privacy Policies</a>
        </section>

        {/* Newsletter Section */}
        <section id='FooterNewsletter' className="flex flex-col space-y-3 text-gray-600 text-center md:text-left">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <button 
              ...
              className="w-full md:w-auto bg-black text-white py-2 px-4 rounded text-sm font-semibold hover:bg-gray-800 transition-colors"
            >
              Subscribe
            </button>
          </div>
