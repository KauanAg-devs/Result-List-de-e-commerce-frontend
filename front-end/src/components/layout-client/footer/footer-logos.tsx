    ...
    <div className="w-full max-w-6xl mx-auto mb-8 md:mb-12 bg-gray-5">
      <div className="flex flex-col items-center md:items-start space-y-4 md:h-32 md:justify-between mb-6 md:mb-10">
        ...
        <div className="flex w-auto gap-4 md:gap-7 justify-center md:justify-start">
          ...
          <svg
            className="fill-[#3f3f46] hover:fill-black cursor-pointer"
            width={20}
            height={20}
            viewBox="0 0 16 16"
          ...
          <svg
            className="bg-[#3f3f46] hover:bg-black rounded-sm p-0.5"
            fill="white"
            width={20}
            height={20}
            viewBox="0 0 32 32"
          ...
          <svg
            className="fill-white bg-[#3f3f46] hover:bg-black rounded-sm p-0.5"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            width={20}
