import { PagesNavigationProps } from "@/types/main/layout-client/pages-navigation";
...
export default function PagesNavigation({
  ...
  return (
    <nav
      id="nav"
      className="bg-[url(/navigation.svg)] bg-black/30 drop-shadow-lg relative h-42 md:h-96 sm:h-22 justify-center items-center flex flex-col w-full p-4 md:p-6 lg:p-8"
    >
